...
本项目中，会话记忆、结构化输出、RAG、工具调用、MCP、护轨、可观测性、AI 代码生成、用户登录/注册等等，都有从 0 的讲解和实践。
...
- **用户认证**: 基于Spring Security的登录认证系统
- **用户注册**: 完整的用户注册功能，支持用户名唯一性校验
...
- [Spring Security](https://spring.io/projects/spring-security) - 强大的安全认证框架
